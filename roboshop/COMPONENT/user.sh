...
sed -ie 's/MONGO_ENDPOINT/mongodb.roboshop-internal/' /home/roboshop/${COMPONENT}/systemd.service
sed -ie 's/REDIS_ENDPOINT/redis.roboshop-internal/' /home/roboshop/${COMPONENT}/systemd.service
statusfunction $?
